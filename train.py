...
if '__main__':
    ...
    argParser.add_argument('--model', type=str, default='mobilenet_v3_l', help='model that will be used for training')
    ...
    argParser.add_argument('--momentum', type=float, default=0.9, help='momentum used for training')
